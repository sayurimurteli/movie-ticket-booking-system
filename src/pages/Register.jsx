...
const Register = () => {
    ...
    return (
        <div
            ...
            style={{ backgroundImage: "url('https://img.freepik.com/free-photo/3d-rendering-cinema-teather_23-2151169420.jpg?t=st=1741198143~exp=1741201743~hmac=90535f97dca233e940541804cfd88a95080436d4f6a95c7f49eebf441549dd8a&w=2000')" }}
        >
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-white bg-opacity-10 backdrop-blur-lg p-6 shadow-xl border border-white/20">
                <h2 className="text-center text-4xl font-extrabold text-white drop-shadow-lg">Register</h2>
                <form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                    <input
                        name="username"
                        type="text"
                        autoComplete="username"
                        {...register('username', { required: true })}
                        className="w-full rounded-lg px-3 py-2 bg-transparent border border-gray-300 text-white placeholder-gray-300 focus:outline-none focus:border-red-500"
                        placeholder="Username"
                    />
                    {errors.username && <span className="text-sm text-red-500">Username is required</span>}
                    ...
                    <button
                        type="submit"
                        className="mt-4 w-full rounded-lg bg-gradient-to-r from-red-600 to-blue-500 py-2 px-4 font-medium text-white shadow-lg hover:from-red-700 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:from-gray-500 disabled:to-gray-400"
                        disabled={isRegistering}
                    >
                        {isRegistering ? 'Processing...' : 'Register'}
                    </button>
                    ...
                    <p className="text-right text-white">
                        Already have an account?{' '}
                        <Link to={'/login'} className="font-bold text-red-400 hover:text-red-500">
                            Login here
                        </Link>
                    </p>
                </form>
